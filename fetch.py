#!/usr/bin/env python3
"""
Recuperation des codes promo Interflora depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/interflora.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/interflora.fr"
STORE_NAME = "Interflora"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Interflora depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-interflora)"
    }
    try:
